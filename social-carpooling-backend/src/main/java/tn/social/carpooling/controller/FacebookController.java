...
public class FacebookController {
  ...
  @ResponseBody
  public String
  createFacebookAuthorization(HttpServletRequest httpServletRequest,
  ...
  public void createFacebookAccessToken(HttpServletRequest request,
    ...
    request.getSession().setAttribute(
        "accessToken", facebookService.createFacebookAccessToken(code));
  ...
  public String getNameResponse(HttpServletRequest request) throws Exception {
    String accessToken =
        (String)request.getSession().getAttribute("accessToken");
